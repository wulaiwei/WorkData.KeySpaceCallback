...
namespace FluentData
{
	...
	internal class ExecuteQueryHandler
	{
		...
		{
		    _command.Data.Context.Data.OnConnectionOpening
                ?.Invoke(new ConnectionEventArgs(_command.Data.InnerCommand.Connection));

		    _command.Data.InnerCommand.Connection.Open();

            _command.Data.Context.Data.OnConnectionOpened
                ?.Invoke(new ConnectionEventArgs(_command.Data.InnerCommand.Connection));
        }
    ...
    public class DB2_10_5Provider : DB2Provider
    {
        public override string ProviderName
        {
            get
            {
                return "IBM.Data.DB2.10.5.0";
            }
        }
    }
