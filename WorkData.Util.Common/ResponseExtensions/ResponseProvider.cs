...
namespace WorkData.Util.Common.ResponseExtensions
{
    public static class ResponseProvider
    {
        ...
        /// <param name="errMsg">消息内容</param>
        /// <returns></returns>
        public static ServerResponse<T> Error<T>(T data, string errMsg, bool status = false) where T:class
        {
        ...
        /// <param name="msg">消息内容</param>
        /// <returns></returns>
        public static ServerResponse<T> Success<T>(T data, string msg = null) where T : class
        {
        ...
        /// <param name="msg">消息内容</param>
        /// <returns></returns>
        public static ServerResponse<T> Error<T>(string msg = null) where T : class
        {
            var result = new ServerResponse<T> { Result = null, Status = false, Message = msg};
